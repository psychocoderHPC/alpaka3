...

    {
        ...
        namespace internal
        {
            ...
            struct MakeDevice::Link<syclGeneric::Platform<T_ApiInterface, T_DeviceKind>>
            {
                ...
                {
                    /* if there is at least one alpaka manged device in the list we can not link devices for the
                    ...
                    if(!hasAlreadyLinkedDevices)
                    {
                        ...
                        std::string platformName
                            = platform.syclPlatform->template get_info<sycl::info::platform::name>();
                    ...
                    auto newDevice
                        = std::make_shared<syclGeneric::Device<syclGeneric::Platform<T_ApiInterface, T_DeviceKind>>>(
