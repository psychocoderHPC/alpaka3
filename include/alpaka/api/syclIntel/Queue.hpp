...
#include "alpaka/api/syclIntel/StaticSharedMem.hpp"
...
#    endif
        ...
        Kernel<syclGeneric::Queue<T_Device>, T_Executor, ThreadSpec<T_NumBlocks, T_NumThreads>, T_KernelBundle>
    {
        ...
        {
            constexpr auto st_shared_mem_bytes = onAcc::syclIntel::StaticSharedMemory::sizeLookupBufferInBytes(
            ...
            queue.m_queue.submit(
                ...
                {
                    using T_Api = decltype(getApi(queue.m_device));
                    ...
                    cgh.parallel_for(
                        ...
                        {
                            onAcc::syclIntel::StaticSharedMemory ssm(st_shared_accessor);
                            onAcc::syclGeneric::DynamicSharedMemory dsm(dyn_shared_accessor);
                            auto acc = onAcc::Acc{
                                onAcc::makeSyclGenericAccDict<T_Executor, T_Api, T_NumBlocks, T_NumThreads>(
                                    work_item,
                                    ssm,
                                    dsm)};
                            kernelBundle(acc);
